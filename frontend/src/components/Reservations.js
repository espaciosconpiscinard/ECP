              ...
              <table class="services-table">
                ...
                <tbody>
                  ...
                  ${reservation.extra_hours && reservation.extra_hours > 0 ? `
                    <tr>
                      <td>0${1 + (reservation.villa_code || reservation.villa_name ? 1 : 0)}</td>
                      <td>Horas Extras</td>
                  ...
                  ${reservation.extra_people && reservation.extra_people > 0 ? `
                    <tr>
                      <td>0${1 + (reservation.villa_code || reservation.villa_name ? 1 : 0) + (reservation.extra_hours > 0 ? 1 : 0)}</td>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* MODALIDADES Y DESCRIPCIONES DE VILLA */}
                {formData.villa_id && (
                  <div className="col-span-2 bg-blue-50 p-4 rounded-lg border-2 border-blue-300">
                    <h4 className="font-bold text-blue-900 mb-3">🏖️ Modalidades de la Villa</h4>
                    ...
                    <div className="flex gap-4 mb-4">
                      <label className="flex items-center space-x-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={villaModalityPasadia}
                          onChange={(e) => setVillaModalityPasadia(e.target.checked)}
                          className="w-4 h-4"
                        />
                      ...
                      <label className="flex items-center space-x-2 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={villaModalityAmanecida}
                          onChange={(e) => setVillaModalityAmanecida(e.target.checked)}
                          className="w-4 h-4"
                        />
                    ...
                    {villaModalityPasadia && (
                      <div className="mb-3">
                        <Label className="text-sm font-semibold text-blue-800">Descripción para Pasadía</Label>
                        <textarea
                          value={formData.villa_description_pasadia}
                          onChange={(e) => setFormData({ ...formData, villa_description_pasadia: e.target.value })}
                          placeholder="Información específica para la modalidad Pasadía..."
                    ...
                    {villaModalityAmanecida && (
                      <div>
                        <Label className="text-sm font-semibold text-blue-800">Descripción para Amanecida</Label>
                        <textarea
                          value={formData.villa_description_amanecida}
                          onChange={(e) => setFormData({ ...formData, villa_description_amanecida: e.target.value })}
                          placeholder="Información específica para la modalidad Amanecida..."
                          className="w-full p-2 border rounded text-sm mt-1"
                          rows="3"
                          style={{ whiteSpace: 'pre-wrap' }}
                        />
                    ...
                    <p className="text-xs text-gray-600 mt-3 bg-white p-2 rounded border">
                      💡 <strong>Nota:</strong> Si seleccionas ambas modalidades, la villa se agregará dos veces en la factura con sus respectivas descripciones
                    </p>
                  </div>
                )}

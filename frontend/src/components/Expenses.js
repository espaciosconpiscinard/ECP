                              ...
                              return (
                                <>
                                  ...
                                  {(() => {
                                    ...
                                    const hasServices = description.includes('servicio(s) adicional(es)');
                                      ...
                                      <>
                                        ...
                                        <div className="flex flex-col gap-1">
                                          <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {hasServices && (
                                              <span className="text-xs px-2 py-0.5 bg-purple-100 text-purple-700 rounded-full font-medium" title="Incluye servicios adicionales">
                                                🛎️ Servicios
                                              </span>
                                            )}
                                            {hasITBIS && (
                                          ...
                                          {/* Mostrar detalles si hay líneas adicionales */}
                                          {description.split('\n').length > 1 && (

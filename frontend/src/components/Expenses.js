                              ...
                              return (
                                <>
                                  ...
                                  {(() => {
                                    ...
                                    const servicesCount = servicesMatch ? parseInt(servicesMatch[1]) : 0;
                                    
                                    // Detectar si incluye extras o servicios (basado en la descripción)
                                      ...
                                      <>
                                        ...
                                        <div className="flex flex-col gap-1">
                                          <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {/* Badges para extras y servicios */}
                                            {servicesCount > 0 && (
                                              <span className="text-xs px-2 py-1 bg-purple-200 text-purple-900 rounded-full font-bold border-2 border-purple-400" title={`Incluye ${servicesCount} servicio(s) adicional(es)`}>
                                                🛎️ {servicesCount} Servicio{servicesCount > 1 ? 's' : ''}
                                              </span>
                                            )}
                                            {hasExtras && (
                                              <span className="text-xs px-2 py-0.5 bg-orange-100 text-orange-700 rounded-full font-medium" title="Incluye horas extras o personas extras">
                                                ➕ Extras
                                              </span>
                                            )}
                                            {hasITBIS && (
                                          ...
                                          {/* Mostrar hint de click */}
                                          {(description.split('\n').length > 1 || servicesCount > 0) && (

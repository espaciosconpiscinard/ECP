...
const VillasManagementNew = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modal para agregar rango de precios */}
      {showPricingTierModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-xl font-bold mb-4 text-purple-800">Agregar Rango de Precio</h3>
            
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-medium mb-1">Personas Mínimo</label>
                  <input
                    type="number"
                    min="1"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Personas Máximo</label>
                  <input
                    type="number"
                    min="1"
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Precio Cliente ($)</label>
                <input
                  type="number"
                  step="0.01"
                  min="0"
              ...
              <div>
                <label className="block text-sm font-medium mb-1">Pago Propietario ($)</label>
                <input
                  type="number"
                  step="0.01"
                  min="0"
